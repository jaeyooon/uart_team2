...
|김서윤|위시리스트 DB 구축 및 CRUD 설계<br>티켓 DB & 예매 DB & 예매내역 DB 수정 <br> 소비자 페이지 위시리스트 조회/추가/중복방지/삭제 <br> 소비자 상세정보페이지 상단부 <br> 소비자 예매페이지(수량선택, 결제예정 수량/금액/사용자정보) <br> 관리자 페이지(차트/서버시간/가입자수/추천전시 롤링배너) |
