...
class InsertOrderlist {
	...
	void contextLoads() { 
		...
		try {
			...
			OrderdetailDTO odetail = new OrderdetailDTO(0, r, 121, "경상남도문화예술회관 제2전시실", new Date("Tue, 18 Oct 2022 00:00:00 +0900"), new Date("Sun, 25 Dec 2022 00:00:00 +0900"), "포토아크, 너의 이름은", 1, new Date("Mon, 26 Dec 2022 00:00:00 +0900"), new Date("Wed, 28 Dec 2022 00:00:00 +0900"), "id10");
